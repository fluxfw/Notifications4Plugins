...
final class UI {
	 ...
	 * @return array
	 */
	public function templateSelection(string $post_key, array $placeholder_types): array {
		return [
			$post_key => [
				...
				"setTitle" => self::plugin()
					->translate("template_selection", ilNotifications4PluginsConfigGUI::LANG_MODULE_NOTIFICATIONS4PLUGIN, [ ilNotifications4PluginsPlugin::PLUGIN_NAME ]),
				"setInfo" => self::output()->getHTML([
					self::plugin()
						->translate("template_selection_info", ilNotifications4PluginsConfigGUI::LANG_MODULE_NOTIFICATIONS4PLUGIN, [ ilNotifications4PluginsPlugin::PLUGIN_NAME ]),
					"<br><br>",
