...
//...
use srag\ActiveRecordConfig\Notifications4Plugins\ActiveRecordConfig;
//...
...
namespace srag\Plugins\X\Config
//...
use srag\ActiveRecordConfig\Notifications4Plugins\ActiveRecordConfigFormGUI;
//...
...
if (\srag\DIC\Notifications4Plugins\DICStatic::dic()->database()->tableExists(\srag\Plugins\X\Config\ConfigOld::TABLE_NAME)) {
    ...
    \srag\DIC\Notifications4Plugins\DICStatic::dic()->database()->dropTable(\srag\Plugins\X\Config\ConfigOld::TABLE_NAME);
}
?>
```
